...
public class AbWheelView extends View {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (label != null && label.length() > 0) {
			...
			if (D)
				Log.d(TAG, "itemsWidth:" + itemsWidth + ",labelWidth:"
						+ labelWidth);
		}
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = ViewUtil.resizeTextSize(screenWidth, screenHeight,
				textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = ViewUtil.resizeTextSize(screenWidth, screenHeight,
				labelTextSize);
	}
