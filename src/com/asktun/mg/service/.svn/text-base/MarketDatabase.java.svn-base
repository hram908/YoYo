...
public class MarketDatabase {
	...
	private static final String SETTING_TABLE = "setting_table";// 保存设置�?	
	private static final String SEARCH_HISTORY_TABLE = "search_history_table";// 保存搜索历史�?	
	private static final String SEARCH_HOTWORDS_TABLE = "search_hotwords_table";// 保存搜索热词�?	
	private static final String RATING_TABLE = "rating_table";// 评分�?	
	private static final String UPDATE_TABLE = "update_table";// 更新�?
