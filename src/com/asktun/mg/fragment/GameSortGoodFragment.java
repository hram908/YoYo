 ...
 * 
 */
public class GameSortGoodFragment extends BaseFragment implements
				...
				holder.btn_download.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (apkItem.status == STATUS_APK_UNINSTALL
							...
							// DownloadUtils
							// .fillUpdateAndUpdatingNotifycation(act,
							// false);
							// }
	...
	private void getGameSortGood(boolean isrefresh) {
		if (isrefresh) {
			page = 1;
			totalDataCount = 1;
			adapter.clear();
	...
	public void onRefresh() {
		getGameSortGood(true);
	}

	@Override
	public void onLoadMore() {
		getGameSortGood(false);
	}
}
